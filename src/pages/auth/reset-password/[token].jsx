...
import { RESET_PASS_ENDPOINT } from 'src/@core/constant/APIEndpoint'
...
const ResetPasswordPage = () => {
  const { resetPasswordApi, isSubmitting } = useAuthStore()
      ...
      <Card sx={{ zIndex: 1 }}>
        <CardContent sx={{ padding: (theme) => `${theme.spacing(12, 9, 7)} !important` }}>
          ...
          <Box sx={{ mb: 6 }}>
            ...
            <Typography variant='body2'>Enter the email with which you registered your account!</Typography>
          </Box>
