...
import { FORGOT_PASS_ENDPOINT } from 'src/@core/constant/APIEndpoint'
...
const ForgotPasswordPage = () => {
  const { forgotPasswordApi, isSubmitting } = useAuthStore()
    ...
    <Box className='content-center'>
      <Card sx={{ zIndex: 1 }}>
        <CardContent sx={{ padding: (theme) => `${theme.spacing(12, 9, 7)} !important` }}>
          ...
          <FormProvider ref={formRef} mode='onTouched' inputs={inputs} />
          <Button
            fullWidth
            size='large'
            type='submit'
