...
import { REGISTER_ENDPOINT } from 'src/@core/constant/APIEndpoint'
...
const inputs = [
  ...
  },
  {
    ...
    maxLength: { value: 12, message: 'Email must not exceed 10 digits' },
    minLength: { value: 1, message: 'Email at least 1 digits' },
...
const RegisterPage = () => {
  // ** States
  const { registerApi, isSubmitting } = useAuthStore()
    ...
    <Box className='content-center'>
      <Card sx={{ zIndex: 1 }}>
        <CardContent sx={{ padding: (theme) => `${theme.spacing(12, 9, 7)} !important` }}>
          ...
          <FormProvider ref={formRef} mode='onTouched' inputs={[...inputs, passwordConfirm]} />
          <FormControlLabel
            control={<Checkbox />}
            label={
              <Fragment>
